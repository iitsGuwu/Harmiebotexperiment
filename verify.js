...
var __extends, WalletAdapter, base_default;
var init_base = __esm({
  "node_modules/@solflare-wallet/sdk/lib/esm/adapters/base.js"() {
    init_eventemitter3();
...
function isInjectedProvider(a) {
  return isObject2(a) && isFunction(a.postMessage);
}
...
var import_bs582, __extends2, __assign, __awaiter, __generator, __read, Wallet, WalletProvider_default;
var init_WalletProvider = __esm({
  "node_modules/@solflare-wallet/sdk/lib/esm/adapters/WalletProvider.js"() {
    init_eventemitter3();
    ...
    (function(_super) {
      ...
      function Wallet2(provider, network) {
        ...
        _this.sign = function(data, display) {
          return __awaiter(_this, void 0, void 0, function() {
            var response, signature2, publicKey2;
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                ...
                case 1:
                  response = _a.sent();
                  signature2 = import_bs582.default.decode(response.signature);
                  publicKey2 = new PublicKey(response.publicKey);
                  return [2, {
                    signature: signature2,
                    publicKey: publicKey2
                  }];
    ...
    WalletProvider_default = Wallet;
  }
});

// node_modules/@solflare-wallet/sdk/lib/esm/adapters/web.js
var import_bs583, __extends3, __awaiter2, __generator2, WebAdapter, web_default;
var init_web = __esm({
  "node_modules/@solflare-wallet/sdk/lib/esm/adapters/web.js"() {
    init_base();
    init_WalletProvider();
    import_bs583 = __toESM(require_bs583());
        ...
        return __awaiter2(this, void 0, void 0, function() {
          ...
          return __generator2(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                signature2 = _a.sent().signature;
                return [2, Uint8Array.from(signature2)];
            }
          });
        });
      };
...
var import_bs584, __extends4, __assign2, __awaiter3, __generator3, IframeAdapter, iframe_default;
var init_iframe = __esm({
  "node_modules/@solflare-wallet/sdk/lib/esm/adapters/iframe.js"() {
    init_index_browser_esm();
    init_base();
    init_esm_browser2();
    import_bs584 = __toESM(require_bs583());
    ...
    (function(_super) {
      ...
      function IframeAdapter2(iframe, publicKey2) {
        var _this = this;
        var _a;
        ...
        _this._publicKey = new PublicKey((_a = publicKey2 === null || publicKey2 === void 0 ? void 0 : publicKey2.toString) === null || _a === void 0 ? void 0 : _a.call(publicKey2));
        return _this;
      }
            ...
            switch (_b.label) {
              ...
              case 1:
                ...
                return [4, this._sendMessage({
                  ...
                  params: {
                    transaction: import_bs584.default.encode(transaction)
                  }
                })];
              case 2:
                signedTransaction = _b.sent();
                return [2, import_bs584.default.decode(signedTransaction)];
              case 3:
                e_1 = _b.sent();
            ...
            switch (_b.label) {
              ...
              case 1:
                ...
                return [4, this._sendMessage({
                  ...
                  params: {
                    transactions: transactions.map(function(transaction) {
                      return import_bs584.default.encode(transaction);
                    })
                  }
                })];
              case 2:
                ...
                return [2, signedTransactions.map(function(transaction) {
                  return import_bs584.default.decode(transaction);
                })];
              case 3:
                e_2 = _b.sent();
        ...
        return __awaiter3(this, void 0, void 0, function() {
          ...
          return __generator3(this, function(_b) {
            switch (_b.label) {
              ...
              case 2:
                result = _b.sent();
                return [2, Uint8Array.from(import_bs584.default.decode(result))];
              case 3:
                e_4 = _b.sent();
...
var __extends5, __assign3, __awaiter4, __generator4, __values, Solflare, esm_default;
var init_esm = __esm({
  "node_modules/@solflare-wallet/sdk/lib/esm/index.js"() {
    init_index_browser_esm();
    init_eventemitter3();
    ...
    (function(_super) {
      ...
      function Solflare2(config) {
        ...
        _this._injectElement = function() {
          ...
          var params = __assign3(__assign3({}, _this._iframeParams), { cluster: _this._network || "mainnet-beta", origin: window.location.origin || "", title: document.title || "", version: 1, sdkVersion: VERSION2 || "unknown" });
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SolflareClass;
      try {
        SolflareClass = (await Promise.resolve().then(() => (init_esm(), esm_exports))).default;
      } catch (error) {
...
// src/verify-client.js
var STANDARD_CONNECT = "standard:connect";
var SOLANA_SIGN_IN = "solana:signIn";
...
function pushDebug(label, data) {
  const entry = `[${(/* @__PURE__ */ new Date()).toISOString().slice(11, 19)}] ${label}${data !== void 0 ? ": " + safeStringify(data) : ""}`;
...
function buildStandardEntry(wallet) {
  return {
    ...
    detail: walletSupportsSignIn(wallet) ? "Ready. Approves with Sign In With Solana." : "Ready. Approves with a signed message.",
    badge: "Detected",
...
function buildAdapterFallbackEntry(fallback) {
  ...
  return {
    ...
    detail: mobile && mobileUrl ? `Tap to open in the ${fallback.name} app.` : loadable ? "Tap to open in the wallet app." : "Not detected on this device.",
...
function buildInstallEntriesForMissing(detectedNames) {
  const detectedKnownIds = /* @__PURE__ */ new Set();
  for (const name of detectedNames) {
    const id = detectKnownId(name);
    if (id) detectedKnownIds.add(id);
  }
  const covered = /* @__PURE__ */ new Set(["phantom", "solflare"]);
  const entries = [];
...
function rebuildEntries() {
  ...
  const adapterEntries = state.adapterFallbacks.map(buildAdapterFallbackEntry).filter(Boolean).filter((entry) => {
...
function renderWallets() {
  ...
  if (hint) {
    ...
    if (isDiscordBrowser()) {
      hint.textContent = "Discord's in-app browser can't launch wallet apps. Tap the \u2022\u2022\u2022 menu and choose \u2018Open in browser\u2019 first.";
    } else {
  ...
  if (state.entries.length === 0) {
    ...
    empty.textContent = "No Solana wallets detected. Install one of the wallets above, then reload this page.";
...
function createWalletCard(entry) {
  ...
  tag.textContent = entry.kind === "standard" ? "detected" : entry.kind === "adapter" ? entry.selectable ? "open app" : "install" : "install";
...
function pickSolanaAccount(wallet) {
  ...
  return accounts.find(
    (account) => (account.chains || []).some((chain) => chain === SOLANA_MAINNET_CHAIN)
  ) || accounts.find((account) => (account.chains || []).some(isSolanaChain)) || accounts[0] || null;
}
async function connectStandardWallet(wallet) {
  ...
  if (!account) {
    ...
    account = accounts.find(
      (entry) => (entry.chains || []).some((chain) => chain === SOLANA_MAINNET_CHAIN)
    ) || accounts.find((entry) => (entry.chains || []).some(isSolanaChain)) || accounts[0] || null;
  }
...
async function verifyWithStandardWallet(entry) {
  ...
  if (signMessageFeature) {
    try {
      ...
      const results2 = await signMessageFeature.signMessage({ account, message });
      const output2 = Array.isArray(results2) ? results2[0] : results2;
      pushDebug("signMessage result", {
        sig: output2?.signature?.length,
        msg: output2?.signedMessage?.length
      });
      if (output2 && output2.signedMessage && output2.signature) {
        return {
          method: "signMessage",
          output: {
            account: {
            ...
            signedMessageBase64: bytesToBase64(output2.signedMessage),
            signatureBase64: bytesToBase64(output2.signature),
            signatureType: output2.signatureType || "ed25519"
          }
        };
      }
      pushDebug("signMessage output malformed", output2);
    } catch (error) {
...
async function verifyWithAdapter(entry) {
  ...
  return {
    ...
    output: {
      ...
      signatureBase64: bytesToBase64(signature2),
